    ...
    >
      <div className="container mx-auto px-4">
        <div className="max-w-3xl">
          ...
          <h1 className="text-5xl sm:text-6xl md:text-7xl leading-tight font-bold mb-3 text-ink pb-1">
            Anjana
          </h1>

          <p className="text-lg sm:text-xl text-text mb-4 flex items-center gap-2">
            <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-section border border-border">
              {/* laptop-code icon */}
              <svg
          ...
          <p className="text-base sm:text-lg text-muted mb-9 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              ...
              className="group inline-flex items-center gap-2 rounded-full px-6 py-3 bg-primary text-white text-sm font-semibold tracking-wide hover:bg-primary-hover hover:scale-[1.01] transition-all duration-200 ease-out"
            >
              <span>GitHub</span>
              <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-primary-hover text-white group-hover:translate-x-0.5 transition-transform duration-200">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 rounded-full px-6 py-3 border border-border bg-section text-ink text-sm font-medium tracking-wide hover:bg-surface hover:border-border-strong hover:scale-[1.01] transition-all duration-200 ease-out"
            >
              <span>LinkedIn</span>
              <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-surface text-primary group-hover:translate-x-0.5 transition-transform duration-200">
                {/* LinkedIn icon */}
                <svg
                  viewBox="0 0 24 24"
                  className="h-3.5 w-3.5"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group inline-flex items-center gap-2 rounded-full px-6 py-3 bg-primary text-white text-sm font-medium tracking-wide hover:bg-primary-hover hover:scale-[1.01] transition-all duration-200 ease-out"
            >
