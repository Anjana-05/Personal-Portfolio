      ...
      <div className="relative p-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2 pt-2">
          <a
            ...
            className="group/btn inline-flex items-center justify-center gap-2 px-3 py-1.5 rounded-lg bg-primary text-white text-xs font-semibold tracking-wide hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/30 active:scale-95 transition-all duration-200 ease-out"
          >
            <span>GitHub</span>
            <svg
          ...
          {project.demo && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group/btn inline-flex items-center justify-center gap-2 px-3 py-1.5 rounded-lg border border-primary/30 bg-primary/5 text-ink text-xs font-semibold tracking-wide hover:bg-primary/10 hover:border-primary/60 hover:shadow-lg hover:shadow-primary/10 active:scale-95 transition-all duration-200 ease-out"
            >
              <span>Live Demo</span>
              <svg
                className="w-3 h-3 group-hover/btn:translate-x-0.5 transition-transform duration-200"
